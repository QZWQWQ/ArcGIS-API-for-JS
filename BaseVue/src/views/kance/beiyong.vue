<template>
  <div id="map"
      ...
      <el-card class="search-card">
        ...
        <div class="search-card-content"
          ...
          <el-form :model="search">
            ...
            <el-divider class="search-card-divider">空间查询</el-divider>
    ...
    <!-- 建筑物 / 钻孔信息操作框 -->
    <div class="updateZkAndBdCardContainer"
         style="display:none">
      <!-- 修改/删除框 -->
      <el-card class="updateZkAndBd-card">
        <div class="updateZkAndBd-card-header">
          <span style="font-size:18px;color:#303133;font-weight:bold">附属建筑物 / 钻孔信息</span>
          <el-button style="float:right;padding:3px 0;font-size:17px;color:#909399;font-weight:bold;line-height:0.5"
                     type="text"
                     @click="showCardVisible = false">关闭</el-button>
        </div>
        <el-divider></el-divider>
        <div class="updateZkAndBd-card-content">
          <el-table :data="searchResult"
                    stripe
                    border
                    style="width: 100%"
                    height="420">
            <el-table-column prop="ZK_ID"
                             label="钻孔编号"></el-table-column>
            <el-table-column prop="PRJ_NAME"
                             label="所属工程"></el-table-column>
            <el-table-column prop="ZK_NAME"
                             label="钻孔名称"></el-table-column>
            <el-table-column prop="ZK_ELV"
                             label="钻孔高程"></el-table-column>
            <el-table-column prop="ZK_DEP"
                             label="钻孔深度"></el-table-column>
            <el-table-column prop="ZK_POS"
                             label="钻孔坐标"></el-table-column>
...
export default {
  ...
  created () {
    ...
    this.$http({
      url: this.$http.adornUrl(`/zk/zk/infoByPrjId/${prjId}`),
      method: 'get'
    }).then(res => {
