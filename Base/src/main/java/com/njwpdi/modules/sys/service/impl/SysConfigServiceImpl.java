...
import com.njwpdi.modules.sys.dao.SysConfigDao;
import com.njwpdi.modules.sys.entity.SysConfigEntity;
import com.njwpdi.modules.sys.redis.SysConfigRedis;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigDao, SysConfigEntity> implements SysConfigService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<SysConfigEntity> page =
            this.page(new Query<SysConfigEntity>().getPage(params), new QueryWrapper<SysConfigEntity>()
